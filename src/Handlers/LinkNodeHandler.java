...
public class LinkNodeHandler extends GooeyListener{
	private CreateNodeHandler cnHandler;
	String projectDir;
	String destination;    //the name of the text component to write to
	GooeyEntryFrame geParentFrame;
	
	public LinkNodeHandler(String dir) {
		projectDir = dir;
	}
	
	public LinkNodeHandler(GooeyEntryFrame geFr, String dest, String projDir) {
		geParentFrame = geFr;
		destination = dest;
		projectDir = projDir;
	}
...
//		}
	...
	public String getSavedNodeID() {
		return cnHandler.getSavedNodeID();
	}
